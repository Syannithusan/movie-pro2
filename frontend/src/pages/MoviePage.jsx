...
const MoviePage = () => {
  ...
  const [traileKey,setTrailekey]=useState(null);
...
fetch(`https://api.themoviedb.org/3/movie/${id}/recommendations?language=en-US&page=1`, options)
  ...
  .then(res => {
    ...
    setTrailekey(trailer?.key || null);
  })
  .catch(err => console.error(err));
  }, [id]);

  if (!movie) {
    return <div className="flex items-center text-white justify-center h-screen">
      <span className="text-xl text-red-500">Loading....</span></div>
  }

  console.log("Movie: ", movie)
  return (
    <div className="min-h-screen bg-[#181818] text-white">
      <div className='relative h-[60vh] flex item-end text-white' style={
        {
        ...
        <div className="absolute inset-0 bg-gradient-to-t from-red-500
        ...
        <div className="relative z-10 flex items-end p-8 gap-8">
          ...
          <div>
            ...
            <Link to={`https://www.youtube.com/watch?v=${traileKey}`}
            target="_blank">
            ...
            mt-2 md:mt-4 md:text-base'> <Play className='mr-2 w-4 h-5 md:w-5 md:h-5'/> 
            Watch Now</button>
            </Link>
          </div>
          ...
          <div className="flex-1">
            <ul className="text-gray-300 space-y-3">
              ...
              <li>
                ...
                <span className="ml-2">
                  {movie.production_companies && movie.
                    production_companies.length > 0 ? movie.production_companies.map((c) =>
                      c.name).join(", ")
                    : "N/A"}
                </span>
              </li>
              ...
              <li>
                ...
                <span className="ml-2">
                  {movie.production_Countries && movie.
                    production_Countries.length > 0 ? movie.production_Countries.map((c) =>
                      c.name).join(", ")
                    : "N/A"}
                </span>
              </li>
              ...
              <li>
                ...
                <span className="ml-2">
                  ...
                  {movie.spoken_languages && movie.
                    spoken_languages.length > 0 ? movie.spoken_languages.map((l) =>
                      l.english_name).join(", ")
                    : "N/A"}
                </span>
              </li>
      ...
      {recommendations.length > 0 && ( 
        <div className="p-8">
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 ">
            ...
            <div key={rec.id} className="bg-[#232323] rounded-lg overflow-hidden
